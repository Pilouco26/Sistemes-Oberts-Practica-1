...
<html>
 ...
 /* you have to exclude the id autogenerated from the list of columns if you have use it. */
            String data[] = new String[]{
                "INSERT INTO Game (id, name, type, console, stock, pathImage) VALUES (1,'Super Mario Bros.', 'Platformer', 'NES', 10, 'images/super_mario_bros.jpg')",
                "INSERT INTO Game (id, name, type, console, stock, pathImage) VALUES (2, 'The Legend of Zelda', 'Action-Adventure', 'NES', 5, 'images/the_legend_of_zelda.jpg')"
            };
